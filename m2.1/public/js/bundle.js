      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "http://127.0.0.1:9000/api/v1/users/signup",
              data: {
                name: name,
                email: email,
                password: password,
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'singed up!');
              (0, _alert.showAlert)('success', 'Proceeding to your home page');
              window.setTimeout(function () {
                location.assign('/memes');
              }, 1500);
            }
...
var memegenrator = document.querySelector('.nav__el--meme');
if (loginForm) loginForm.addEventListener("submit", function (eve) {
  eve.preventDefault();
...
if (memegenrator) memegenrator.addEventListener("click", function () {
  window.open("https://adityasunny1189.github.io/Meme-World/");
});
if (SingupForm) SingupForm.addEventListener("submit", function (eve) {
  eve.preventDefault();
